...
-- Design Ports Information
-- output	=>  Location: PIN_U7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- s	=>  Location: PIN_W6,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF mux2input1bit IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \output~0_combout\ = (\s~input_o\ & ((\b~input_o\))) # (!\s~input_o\ & (\a~input_o\))
